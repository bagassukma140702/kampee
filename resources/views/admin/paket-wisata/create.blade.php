<x-admin-layout>
    <x-slot name="header">
        <h2 class="text-3xl font-semibold text-gray-900">Tambah Paket Wisata Baru</h2>
        <p class="text-gray-600 mt-1">Masukkan data lengkap untuk menambahkan paket wisata</p>
    </x-slot>
        ...
        <div class="bg-white rounded-xl shadow-md overflow-hidden">
            <div class="">
                <form action="{{ route('admin.paket-wisata.store') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select name="tipe_harga" id="tipe_harga" required
                                    ...
                                    <option value="per_pasangan">Per Pasangan</option>
                                    <option value="per_paket">Per Paket</option>
                                </select>
                            </div>
                            <div>
                    ...
                    <!-- Komponen Fasilitas -->
                    <div class="rounded-lg p-6">
                        <h3 class="text-lg font-semibold text-gray-800 mb-4 pb-2 border-b border-gray-200">Fasilitas
                        </h3>
                        <div x-data="{ fasilitasList: [{ nama: '' }] }">
                            ...
                            <button type="button" @click="fasilitasList.push({ nama: '' })"
                                class="mt-2 inline-flex items-center px-3 py-1.5 border border-transparent text-xs font-medium rounded text-emerald-700 bg-emerald-100 hover:bg-emerald-200">
                    ...
                    <!-- Biaya Komponen -->
                    <div class=" rounded-lg p-6">
                        <h3 class="text-lg font-semibold text-gray-800 mb-4 pb-2 border-b border-gray-200">Komponen
                            Biaya</h3>
                        <div x-data="{ biayaList: [{ nama: '', jumlah: 0 }] }">
                                    ...
                                    <div class="col-span-4 md:col-span-5">
                                        <div class="relative rounded-md shadow-sm">
                                            ...
                                            <input type="number" :name="`biaya[${index}][jumlah]`"
                                                ...
                                                class="block w-full pl-10 pr-12 rounded-md border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 text-sm">
                                        </div>
                                    </div>
